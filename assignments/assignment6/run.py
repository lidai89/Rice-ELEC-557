...
if __name__ == '__main__':
    ...
    shell_parser.add_argument('--featureFunction', type=str, default='binary', choices=['unary', 'binary', 'ner'], help='Feature function to use for your CRF' )
    shell_parser.set_defaults(func=run_command_line)

    train_parser = subparsers.add_parser('train', help='Train a CRF' )
    train_parser.add_argument('--featureFunction', type=str, default='binary', choices=['unary', 'binary', 'ner'], help='Feature function to use for your CRF' )
